    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-9 col-xl-8">
        <div class="mb-4 text-center">
          <span class="badge text-bg-primary mb-2">FIT5032 Assessed Lab 5</span>
          <h1 class="h2 fw-bold">Library Registration Form</h1>
        </div>

        <form class="border rounded bg-white p-3 p-sm-4 shadow-sm" novalidate @submit.prevent="submitForm">
          <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              >
              <div class="form-text">
                This field uses v-bind:value for one-way data binding.
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <div v-if="friendMessage" class="valid-feedback d-block">
...
const validateConfirmPassword = (blur) => {
  const hasValue = formData.value.confirmPassword.length > 0
  const matchesPassword = formData.value.confirmPassword === formData.value.password
  const message = hasValue && matchesPassword
    ? null
    : 'Passwords do not match'
  return setError('confirmPassword', message, blur)
}
